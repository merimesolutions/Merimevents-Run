...
if ($response->success == true){
  ...
  echo '<script>alert("Error in Google reCAPTACHA");window.location="register"</script>';
}
$status= "active";
$date=date("Y-m-d");
// cite - 6Le0qSIgAAAAAHL4APU98muxBjZHd32T-wfIMtVb
// secret - 6Le0qSIgAAAAAOKIfwonSpMamFtVQ_pX1SOkEiTU
...
$sql = "INSERT INTO tblstaff(full_name,companyname,location,email, contact,username,accounttype,company,package,reg_date,otp) VALUES ('$full_name','$company','$location','$email','$contact','$username','$acc','$company','$package','$date','$pass')";
$sqluser = "INSERT INTO tblusers(username,full_name,company) VALUES ('$username','$full_name','$company')";
