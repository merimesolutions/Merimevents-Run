  ...
  $("#myInput").on("keyup", function() {
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header" style="border-style:;border:1px solid #dedede;">
                    ...
                    <a href="ilpr?tm=<?php echo $_GET['tm']; ?>" target="_blank" ><i class="fa fa-print" aria-hidden="true" title="Print"></i> Print</a>
                </section>
                <form method="post">
            ...
            while($r = $client->fetch(PDO::FETCH_OBJ)){
                ...
                date_default_timezone_set('Africa/Nairobi');
                                            ...
                                            <tr> 
                                                ...
                                                <td>'.$row->price.'</td> 
                                                <td>'.$dif.'</td>
                                                <td style="text-align: right;">'.number_format(($row->price*$row->qnty*$dif)).'</td>
                                                </tr>
    ...
    $ttle = mysqli_fetch_array($total);
                              ...
                              <tr>
                                  ...
                                  <th style="text-align: right;"><?php echo number_format(($ttle['product']),2); ?></th>
                              </tr>
                              <?php
