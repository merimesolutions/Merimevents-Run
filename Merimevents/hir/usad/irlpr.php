...
class myPDF extends FPDF{
    ...
    function viewTable($con){
        ...
        $this->Cell(55,6,'Item', 1,0,'L');
        $this->Cell(25,6,'Leased date', 1,0,'L');
        $this->Cell(27,6,'Returning Date', 1,0,'L');
        $this->Cell(25,6,'Qnty', 1,0,'L');
        ...
        $this->Cell(25,5,ucwords($row['client']), 1,0,'L');
        $this->Cell(55,5,ucwords($row['item_name']), 1,0,'L');
        $this->Cell(25,5,ucwords($row['ldate']), 1,0,'L');
        $this->Cell(27,5,ucwords($row['rdate']), 1,0,'L');
