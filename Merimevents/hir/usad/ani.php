        ...
        if(isset($_POST['save'])){
            ...
            $company=$_SESSION['company'];
                ...
                foreach($txtItem_name as $key => $value){
                    $save = "INSERT INTO tblitems(item_name,qnty,category,bno,added_by,added_date,company,supplier,receipt,lease_charges)VALUES('".$value."','".$txtQnty[$key]."','".$txtCategory[$key]."','".$txtBatch[$key]."','".$served_by."','".$date."','".$company."','".$txtSupplier[$key]."','".$txtReceipt[$key]."','".$txtPrice[$key]."' )";
