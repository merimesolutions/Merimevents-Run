        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <div class="form-row">
                    <a href="view_event.php?id=<?php echo $event_id; ?>" class="btn btn-sm btn-danger form-group"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
                                        ...
                                        while($hd = mysqli_fetch_array($ddd)){
                                            ...
                                            if($sqme && $sqle){
                                                echo'<script>alert("Quotation Added succesfully!");window.location="view_event.php?id='."$event_id".'";</script>';
                                                 ...
                                                 echo'<script>alert(" An error occured during submission'."$error".'");window.location="add_quote2.php?id='."$event_id".'";</script>';
                                            }
                                            if(!$sqle){
                                                  echo'<script>alert(" Error:'."$err".'");window.location="add_quote2.php?id='."$event_id".'";</script>';
                                            }
                                        }
                                        ?>
