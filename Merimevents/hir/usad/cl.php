        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                  <center><a href="add" title="Lease item" class="btn btn-info btn-sm">  Lease Items</a></center>
                    <div class="row">
                        <div class="box">
                        <!-- left column -->
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><center><a data-target="#editModal'.$row['id'].'" data-toggle="modal"><img src="../../images/icons/edit.png" title="Edit this record" class="iconb"></a></center></td> 
