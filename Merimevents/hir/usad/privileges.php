        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <ul  class="nav nav-pills">
                			<li class="active">
                             <a  href="#1a" data-toggle="tab" class="bg-info rounded">Dashboard</a>
                			</li>
                			<li>
                			 <a href="#3a" data-toggle="tab" class="bg-info rounded">Customer</a>
                			</li>
                			<li>
                			 <a href="#4a" data-toggle="tab" class="bg-info rounded">Leasing</a>
                			</li>
                			<li>
                			 <a href="#5a" data-toggle="tab" class="bg-info rounded">Tasks</a>
                			</li>
                			<li>
                			 <a href="#6a" data-toggle="tab" class="bg-info rounded">Events</a>
                			</li>
                			<li>
                			 <a href="#7a" data-toggle="tab" class="bg-info rounded">Inventory</a>
                			</li>
                			<li>
                			 <a href="#8a" data-toggle="tab" class="bg-info rounded">Return Items</a>
                			</li>
                			<li>
                			 <a href="#9a" data-toggle="tab" class="bg-info rounded">Penalties</a>
                			</li>
                			<li>
                			 <a href="#10a" data-toggle="tab" class="bg-info rounded">Invoices</a>
                			</li>
                			<li>
                			 <a href="#11a" data-toggle="tab" class="bg-info rounded">Reports</a>
                			</li>
                			<li>
                			 <a href="#12a" data-toggle="tab" class="bg-info rounded">User Accounts</a>
                			</li>
                			<li>
                			 <a href="#13a" data-toggle="tab" class="bg-info rounded">Settings</a>
                			</li>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="cregister" id="cregister" value="'.$r.'">
                                                ...
                                                <td> <input type="checkbox" id="cleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="cleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="clease" id="clease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="creturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="creturn" id="creturn" value="'.$re.'"></td>
                                                ...
                                                <td><input type="checkbox" id="cinventories" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="cinventory" id="cinventory" value="'.$i.'"></td>
                                                 
                                                </tr>
                                                 <tr>
                                                <td>Leaese items</td>
                                                
                                                <td><input type="checkbox" id="cpenalties" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="cpenalty" id="cpenalty" value="'.$p.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="lregister" id="lregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="lleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="lleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="llease" id="llease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="lreturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="lreturn" id="lreturn" value="'.$re.'"></td>
                                                ...
                                                <td><input type="checkbox" id="linventories" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="linventory" id="linventory" value="'.$i.'"></td>
                                                ...
                                                <td><input type="checkbox" id="lpenalties" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="lpenalty" id="lpenalty" value="'.$p.'"></td>
                                                ...
                                                <td><input type="checkbox" id="linvoices" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="linvoice" id="linvoice" value="'.$in.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="myregister" id="myregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="myleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="lleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="mylease" id="mylease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="myreturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="myreturn" id="myreturn" value="'.$re.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="eregister" id="eregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="eleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="eleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="elease" id="elease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="ereturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="ereturn" id="ereturn" value="'.$re.'"></td>
                                                ...
                                                <td><input type="checkbox" id="einventories" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="einventory" id="einventory" value="'.$i.'"></td>
                                                ...
                                                <td><input type="checkbox" id="epenalties" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="epenalty" id="epenalty" value="'.$p.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="iregister" id="iregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="ileases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="ileases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="ilease" id="ilease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="ireturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="ireturn" id="ireturn" value="'.$re.'"></td>
                                                ...
                                                <td><input type="checkbox" id="iinventories" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="iinventory" id="iinventory" value="'.$i.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="rregister" id="rregister" value="'.$r.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="pregister" id="pregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="pleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="pleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="please" id="please" value="'.$l.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="invregister" id="invregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="invleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="invleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="invlease" id="invlease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="invreturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="invreturn" id="invreturn" value="'.$re.'"></td>
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="r_register" id="r_register" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="r_leases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="r_leases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_lease" id="r_lease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="r_returns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_return" id="r_return" value="'.$re.'"></td>
                                                ...
                                                <td><input type="checkbox" id="r_inventories" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_inventory" id="r_inventory" value="'.$i.'"></td>
                                                ...
                                                <td><input type="checkbox" id="r_penalties" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_penalty" id="r_penalty" value="'.$p.'"></td>
                                                ...
                                                <td><input type="checkbox" id="r_invoices" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_invoice" id="r_invoice" value="'.$in.'"></td>
                                                ...
                                                <td><input type="checkbox" id="r_reports" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_report" id="r_report" value="'.$rep.'"></td>
                                                ...
                                                <td><input type="checkbox" id="r_projects" data-toggle="toggle" data-on="Enable" data-off="Disable"  data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="r_project" id="r_project" value="'.$pr.'"></td>
                                            ...
                                            ?>
                                             <script>
                                                ...
                                                //---------
                                                 if( ev =='1'){
                                                    $('#r_events').bootstrapToggle('on');
                                                }else{
                                                    $('#r_events').bootstrapToggle('off')
                                                }
                                                //---------
                                                   if( invoice =='1'){
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $c=1;
                                                ...
                                                <input type="hidden" name="uregister" id="uregister" value="'.$r.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="uleases" data-toggle="toggle" data-on="Enable" data-off="Disable"  name="uleases" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="ulease" id="llease" value="'.$l.'"></td>
                                                ...
                                                <td> <input type="checkbox" id="ureturns" data-toggle="toggle" data-on="Enable" data-off="Disable" data-size="sm"  data-onstyle="success" data-offstyle="danger"><input type="hidden" name="ureturn" id="ureturn" value="'.$re.'"></td>
                                            ...
                                            ?>
                                             <script>
                                                ...
                                                var r ="<?php echo  $u_add_user;?>";
                                                var l = "<?php echo $u_delete;?>";
                                                var re = "<?php echo $u_edit;?>";
