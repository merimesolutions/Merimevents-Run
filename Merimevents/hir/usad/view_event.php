                        ...
                        <?php
                          ...
                          if($e){
                              ...
                              if($y > 0){
                                                    ...
                                                    echo '<H2>Approved Quotation</h2>'; 
                                                    echo '<a class="btn btn-success btn-sm form-group" style="margin-top:30px;margin-bottom:30px;" href="edit_quotation.php?id='.$event_id.'"><i class="fas fa-edit"></i>&nbsp;Edit Quotation</a>';
