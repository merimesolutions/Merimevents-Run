<?php
   echo  '<header class="header">
      ...
      <a href="#" class="dropdown-toggle" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-bell" style="font-size:18px;"> <span style="border-radius:50%; color:red;">';
