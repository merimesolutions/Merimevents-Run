            ...
            <aside class="right-side">
                ...
                <section class="content-header"  >
                    ...
                    <a href="acc.php" title="Go home"><i class="fa fa-plus" aria-hidden="true" title="Add new account"></i> Add User</a>&nbsp;&nbsp;
                      <?php } if($u_delete==1){?> 
                    <a data-toggle="modal" data-target="#deleteAcc" title="Delete"><i class="fa fa-trash" aria-hidden="true" title="Add new account"></i> Delete</a>
                        <?php } ?>
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th style="width: 20px !important;"><input type="checkbox" name="chk_delacc[]" class="cbxMain" onchange="checkMain(this)" />
                                                <th>Full Name</th>
                                                <th>Username</th>
                                                <th>Role</th>
                                                <?php if($u_edit==1){?>
                                           ...
                                           $sq = mysqli_query($con, "select * from tblroles where id='".$r."' ORDER BY id DESC");
                                            ...
                                            {     
                                               $role =  $rows['role'];
                                                ...
                                                echo '
                                            <tr>
                                        <td><input type="checkbox" name="chk_delacc[]" class="chk_delete" value="'.$row['id'].'" /></td> 
                                        <td>'.ucwords($row['full_name']).'</td>
                                        <td>'.$row['username'].'</td>
                                        <td>'.ucwords($role).'</td>';
                                        if($u_edit==1){
                                      
                                        echo '<td><center><a href=editacc.php?id='.$row['id'].'><img src="../../images/icons/doc_edit.png" title="" class="iconb"></a></center></td>';
                                        }
                                        echo '
                                                </tr>
                                                ';
