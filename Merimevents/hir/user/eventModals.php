  ...
  <div class="modal-dialog modal-sm" style="width:400px !important;">
    <div class="modal-content">
        <div class="modal-header" style="">
            ...
            <h4 class="modal-title"><center>Edit Task Assignment</center></h4>
        </div>
        <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <strong><h4 class="text-center font-weight-bold" style="font-family:fangsong; margin-bottom:30px!important"><?php echo $eventt_name ?></h4></strong>
            ...
            ?>
                  ...
                  <div class="form-group">
                       ...
                       <select class="form-control" name="task_role"  >
                           ...
                           <option disabled selected>Select Role</option>  <!--<option value="Bomet" <?php echo (in_array("Bomet", $va)?'selected':''); ?>>Bomet</option>-->
