...
$sql_roles ="SELECT tblroles.role, tblroles.register, tblroles.lease, tblroles.returning, tblroles.inventory, tblroles.penalty, tblroles.invoice, tblroles.report,
...
FROM tblroles
INNER JOIN tblusers ON tblroles.id = tblusers.role";
