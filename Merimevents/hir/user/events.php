                                    ...
                                    <table id="table" class="table  table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Start Date</th>
                                                <th>End Date</th>
                                                <?php  if($e_task_assigment==1){
                                                 echo '<th>Tasks Assignment</th>';
                                                }if($e_add_quotation==1){
                                                echo ' <th>Add Quotation</th>';
                                                }
                                                 if($e_generate_invoice==1){
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                if($e_task_assigment==1){
                                                 echo ' <td><center><a data-target="#taskass'.$row['id'].'" data-toggle="modal" class="btn btn-success"><i class="fas fa-users"></i></a></center></td>';
                                                }
                                                if($e_add_quotation==1){
                                                  
                                                echo '<td><center><a href="add_event_quotation.php?id='.$row['id'].' " class="btn" ><img src="../../images/icons/doc_edit.png" title="Edit this record" class="iconb"></a></center></td>';
                                                }
                                                if($e_generate_invoice==1){
                                                echo '<td><center><a href="print-quotation?id='.$row['id'].' " class="btn btn-info" target="_blank"><i class="fas fa-file-invoice"></i></a></center></td>';
                                                }
                                                if($e_all_details==1){
                                                echo '<td><center><a href="view_event.php?id='.$row['id'].'" ><img src="../../images/icons/eye.png" title="Edit this record" class="iconb"></a></center></td>';
                                                }
                                                echo '                                  
                                                </tr>
                                                ';
                                              
                                                require_once "eventModals.php";
