            ...
            <aside class="right-side">
                ...
                <section class="content-header" style="border-style:;border:1px solid #dedede;">
                    <a  href="javascript:void(0)"  title="Go Back" onclick="goBack()" ><i class="fa fa-angle-double-left" ></i> Back</a>&nbsp;&nbsp;&nbsp;
                     <a href="javascript:void(0)" onclick="javascript:window.open('prr.php', '_Details', 'width=1000, height=700, scrollbars=1, resizable=1');"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Print</a>
