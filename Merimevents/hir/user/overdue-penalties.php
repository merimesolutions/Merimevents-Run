                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    $q = "SELECT * FROM tbloverdate where item_name_id_overdue ='".$z."' and client='".$client."' ";
                                            ...
                                            <tr> 
                                                ...
                                                ';if($oc_receipt==1){
                                                echo '<td><center><a href="overdue-transactions.php?tjk78wenm4yuwernmnmzxcyunmnmztye7834nm434nm43rf//578nmsdjn//sdfjkmerime='.$rows['client'].'"><img src="../../images/icons/eye.png" title="Edit this record" class="iconb"></a></center></td>';
                                                }
                                                if($oc_preview==1){
                                                echo '<td><a class="btn btn-success" href=penalties-invoice.php?tm='.$rows['client'].' target="_blank">Preview</a></td>';
                                                }
                                                echo '
                                                </tr>
