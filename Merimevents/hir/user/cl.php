        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header" style="border-style:;border:1px solid #dedede;">
                    ...
                    <?php }   if($c_print==1){?>
                     <a href="clprev" title="" ><i class="fa fa-print" aria-hidden="true" title="Lease item"></i> Print</a>
                     <?php }?>
                ...
                <section class="content">
                  ...
                  <div style="display:flex;">  <p>Registered Customers</p> &nbsp;&nbsp;&nbsp; <a href="add.php" title="Lease item" class="btn btn-info btn-sm">  Lease Items</a></div>
                  <?php }?>
                    <div class="row">
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             if($c_edit==1){
                                                echo '<td><center><a data-target="#editModal'.$row['id'].'" data-toggle="modal"><img src="../../images/icons/edit.png" title="Edit this record" class="iconb"></a></center></td>';
                                             }
                                                
                                              echo '<!--td><center><a href=../reports/ocrr?cus='.$row['id'].' target="_blank"><img src="../../images/icons/printer.png" title="Print this record" class="iconb"></a></center></td-->                                 
                                                </tr>
                                                ';
