                        ...
                        $z=$row['item_name_id'];
                            $q = "SELECT * FROM tblcleared where item_name_id_clear ='".$z."' and client='".$cb."' ";
                                            ...
                                            <td>'.ucwords($row['fname']).' '.ucwords($row['mname']).' '.ucwords($row['lname']).'</td>
                                                ...
                                                if($di_clear==1){
                                                 echo ' <td><button class="btn btn-primary btn-sm" data-target="#editDi'.$row['item_id'].'" data-toggle="modal" style="width:100%" title="Click to clear this record"> Clear </button></td>';   
                                                }
                                               echo '
