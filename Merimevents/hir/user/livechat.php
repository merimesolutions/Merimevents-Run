...
<?php
    if(isset($_POST['okay'])){
        ...
        $result = mysqli_query($con,"INSERT INTO faq (user,faq_message,ask_date) VALUES ('$user','$faqmessage','$todate')");
       if($result==true){
...
<!-- Comments section start -->
  ...
  <main class="msger-chat">
         <?php $sql090=mysqli_query($con,"SELECT * FROM faq WHERE user='".$_SESSION['userid']."'");
    ...
    <div class="msg right-msg">
      ...
      <div class="msg-bubble" style="background-color:#ddff99;">
        ...
        <div class="msg-text" style="color: black !important;">
          <?php echo $faqmessage1; ?> <br><small style="color:grey;font-size:9px;"> <?php echo $askdate1; ?></small>
        </div>
      </div>
    </div>
...
<?php 
    $wery=mysqli_query($con,"SELECT * FROM faq WHERE user='".$_SESSION['userid']."' AND id='$faqid'");
    if($wery){
        while($rop =mysqli_fetch_assoc($wery)){
            
    $faqresponse=$rop['faq_response'];
    $responsedate=$rop['response_date'];
     
    ?>
    <?php if(!empty($faqresponse)){
    ...
    <div class="msg left-msg">
      ...
      <div class="msg-bubble" style="background-color:#fff;">
        <div class="msg-info" style="color: black!important;">
          <div class="msg-info-name"></div>
          <div class="msg-info-time"></div>
        </div>

        <div class="msg-text" style="color: black !important;">
          '."$faqresponse".' <br><small style="color:grey;font-size:9px;"> '."$responsedate".'</small>
        </div>
      </div>
    </div>
';?>
