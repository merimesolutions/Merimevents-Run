        ...
        <?php
          ...
          <div class="col-md-6 col-md-offset-3 ">
            ...
            <div class="panel-body">
              <form role="form" action="res.php" method="post">
                ...
                <input type="hidden" name="pass" value="<?php echo RandomString(8); ?>"/>
                <button type="submit" class="btn btn-sm btn-success" name="submit" title="Click to login" style="width:">Request</button>
                <a href="login.php" style="float: right;padding: 5px"> Go home</a>
              </form><br>
              <p>Customer care</p>
              <a href="https://api.whatsapp.com/send?phone=+254757414345" target="_blank">
                  <img src="images/icons/whatsapp.png" title="Whatsapp us" class="iconb" alt="Whatsapp">
              </a>      
              <a href="mailto:contactus@merimesolutions.com?subject=" target="_blank">
                  <img src="images/icons/mail.png" title="Mail us" class="icon" alt="Mail">
              </a>
              <a href="https://www.merimesolutions.com/" target="_blank">
                  <img src="images/icons/website.png" title="Find our website" class="icon" alt="Our website">
              </a>
            </div>
          </div>          
          </div>
