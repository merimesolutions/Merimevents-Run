        ...
        if ($_SESSION['merime'] == "merime") {
            echo '<li class="active" style="border-style:none">
                         ...
                         <li class="active" style="border-style:none">
                            ...
                            <li style="border-style:none">
                                <a href="../admin/demo.php">
                                    <img src="../../images/icons/backup-img.png" title="Demo requests" class="icon-b"> <span style="color:#fff;">Demo requests</span>
                                </a>
                            </li>';
