                                ...
                                <div class="box-body table-responsive">
                                   ...
                                   <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $c=1;
                                            $squery = mysqli_query($con, "select * from tblstaff where status ='inactive'  or status IS NULL ORDER BY id DESC");
                                        ...
                                        <td>'.$package.'</td>
                                        <td>'.$n.'</td>
                                        <td style="color:red;font-weight:bold;">'.ucwords($status).'</td>
