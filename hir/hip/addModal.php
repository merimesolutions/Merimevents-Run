  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <input type="reset" class="btn btn-default btn-sm" data-dismiss="modal" value="Cancel"/>
...
<form method="post">
  <div class="modal-dialog modal-sm" style="width:450px !important;">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" style="color:teal; font-weight:bold;"><center>Add Product / Service</center></h4>
        </div>
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-striped" id="table_field">
                                            ...
                                            <tr>
                                                <td><input type="text" name="txtPs[]" class="form-control" required placeholder="Enter product / service"></td>
        ...
        <div class="modal-footer">
            <input type="button" class="btn btn-default btn-sm" data-dismiss="modal" value="Cancel"/>
            <input type="submit" class="btn btn-primary btn-sm" id="btn_add_ps" name="btn_add_ps" value="Save"/>
        </div>
    </div>
  </div>
  </form>
  <script type="text/javascript">
        $(document).ready(function() {
            var html = '<tr><td><input type="text" name="txtPs[]" class="form-control" required placeholder="Add product / service" ></td><td><input type="button" name="remove" id="remove" value="x" class="btn btn-danger"></tr>';
