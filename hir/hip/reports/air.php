...
class myPDF extends FPDF{
    function header(){
        ...
        $this->Cell(53,6,'Quality', 1,0,'L');
        $this->Cell(53,6,'Category', 1,0,'L');
        $this->Cell(25,6,'Added Date', 1,0,'L');
        $this->Ln();
        ...
        $this->Cell(53,6,ucwords($data->qlty), 1,0,'L');
        $this->Cell(53,6,ucwords($data->category), 1,0,'L');
        $this->Cell(25,6,$data->added_date, 1,0,'L');
        $this->Ln();
        $c++;
        }
