...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                   ...
                   <div class="panel-heading" >
                    ...
                    <form action="searchpdf.php" target="_blank" method="POST">
                     <input type="date" required class="input-sm" name="searchdate" id="searchdate" placeholder="Y-m-d e.g 2030-09-22" />
                        ...
                        <td align="center" style="color: red;font-size: 16px;font-weight: bold">Results for " <?php $date = $_POST['searchdate']; echo $date; ?>"</td>
                    </tr>
                </table>
                    <hr>
            ...
            $today=date("Y-m-d");
            $s=mysqli_query($con,"select * from tblreport WHERE estate='".$_SESSION['estate']."' and category = 'sickness' and today='$searchdate' ");
            $c=1;
        ...
        <tr>
              ...
              <td align="center" style="background-color: lightgray;font-weight: bold;"><?php
                                            $q = mysqli_query($con,"SELECT * from tblreport where estate='".$_SESSION['estate']."' and category = 'sickness' and today='$searchdate' ");
         ...
         <table id="datatable" class="" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tr style="background-color: skyblue">
             ...
             $ond=mysqli_query($con,"select * from tblreport WHERE estate='".$_SESSION['estate']."' and category = 'On-Duty Injury' and today='$searchdate' ");
            $c=1;
        ...
        <tr>
              <td colspan="5" align="right" style="color:black;font-weight: bold;">Sub Total:</td>
              <td align="center" style="background-color: lightgray;font-weight: bold;"><?php
                                            $q = mysqli_query($con,"SELECT * from tblreport where estate='".$_SESSION['estate']."' and category = 'On-Duty Injury' and today='$searchdate' ");
        ...
        <table id="datatable" class="" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <?php
             $ofd=mysqli_query($con,"select * from tblreport WHERE estate='".$_SESSION['estate']."' and category = 'Off-Duty Injury' and today='$searchdate' ");
            $cc=1;
        ...
        <tr>
              <td colspan="5" align="right" style="color:black;font-weight: bold;">Sub Total:</td>
              <td align="center" style="background-color: lightgray;font-weight: bold;"><?php
                                            $q = mysqli_query($con,"SELECT * from tblreport where estate='".$_SESSION['estate']."' and category = 'Off-Duty Injury' and today='$searchdate' ");
        ...
        <table id="datatable" class="" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <?php
             $dep=mysqli_query($con,"select * from tblreport WHERE estate='".$_SESSION['estate']."' and purpose='Treatment' and today='$searchdate' ");
            $ccc=1;
        ...
        <tr>
              <td colspan="5" align="right" style="color:black;font-weight: bold;">Sub Total:</td>
              <td align="center" style="background-color: lightgray;font-weight: bold;"><?php
                                            $q = mysqli_query($con,"SELECT * from tblreport where estate='".$_SESSION['estate']."' and purpose='Treatment' and today='$searchdate' ");
         ...
         <table id="datatable" class="" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <?php
             $none=mysqli_query($con,"select * from tblreport WHERE estate='".$_SESSION['estate']."' and category = 'Non Employee' and today='$searchdate' ");
            $ccc=1;
        ...
        <tr>
              ...
              <td align="center" style="background-color: lightgray;font-weight: bold;"><?php
                                            $q = mysqli_query($con,"SELECT * from tblreport where estate='".$_SESSION['estate']."' and category = 'Non Employee' and today='$searchdate' ");
