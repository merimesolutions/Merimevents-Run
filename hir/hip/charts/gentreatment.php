...
//sickness
$qs= mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$now."' ");
                $sickness = mysqli_num_rows($qs);
$qs1 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d1."' ");
                $sickness1 = mysqli_num_rows($qs1);
$qs2 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d2."' ");
                $sickness2 = mysqli_num_rows($qs2);
$qs3 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d3."' ");
                $sickness3 = mysqli_num_rows($qs3);
$qs4 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d4."' ");
                $sickness4 = mysqli_num_rows($qs4);
$qs5 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d5."' ");
                $sickness5 = mysqli_num_rows($qs5);
$qs6 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d6."' ");
                $sickness6 = mysqli_num_rows($qs6);
$qs7 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d7."' ");
                $sickness7 = mysqli_num_rows($qs7);
$qs8 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d8."' ");
                $sickness8 = mysqli_num_rows($qs8);
$qs9 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d9."' ");
                $sickness9 = mysqli_num_rows($qs9);
$qs10 = mysqli_query($con,"SELECT * from tblreport where category='sickness' and period='".$d10."' ");
                $sickness10 = mysqli_num_rows($qs10);

//On-Duty Injury
$qod= mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$now."' ");
                $sicknessod = mysqli_num_rows($qod);
$qod1 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d1."' ");
                $sicknessod1 = mysqli_num_rows($qod1);
$qod2 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d2."' ");
                $sicknessod2 = mysqli_num_rows($qod2);
$qod3 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d3."' ");
                $sicknessod3 = mysqli_num_rows($qod3);
$qod4 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d4."' ");
                $sicknessod4 = mysqli_num_rows($qod4);
$qod5 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d5."' ");
                $sicknessod5 = mysqli_num_rows($qod5);
$qod6 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d6."' ");
                $sicknessod6 = mysqli_num_rows($qod6);
$qod7 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d7."' ");
                $sicknessod7 = mysqli_num_rows($qod7);
$qod8 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d8."' ");
                $sicknessod8 = mysqli_num_rows($qod8);
$qod9 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d9."' ");
                $sicknessod9 = mysqli_num_rows($qod9);
$qod10 = mysqli_query($con,"SELECT * from tblreport where category='On-Duty Injury' and period='".$d10."' ");
                $sicknessod10 = mysqli_num_rows($qod10);
//Off-Duty Injury
$qofd= mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$now."' ");
                $sicknessofd = mysqli_num_rows($qofd);
$qofd1 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d1."' ");
                $sicknessofd1 = mysqli_num_rows($qofd1);
$qofd2 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d2."' ");
                $sicknessofd2 = mysqli_num_rows($qofd2);
$qofd3 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d3."' ");
                $sicknessofd3 = mysqli_num_rows($qofd3);
$qofd4 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d4."' ");
                $sicknessofd4 = mysqli_num_rows($qofd4);
$qofd5 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d5."' ");
                $sicknessofd5 = mysqli_num_rows($qofd5);
$qofd6 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d6."' ");
                $sicknessofd6 = mysqli_num_rows($qofd6);
$qofd7 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d7."' ");
                $sicknessofd7 = mysqli_num_rows($qofd7);
$qofd8 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d8."' ");
                $sicknessofd8 = mysqli_num_rows($qofd8);
$qofd9 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d9."' ");
                $sicknessofd9 = mysqli_num_rows($qofd9);
$qofd10 = mysqli_query($con,"SELECT * from tblreport where category='Off-Duty Injury' and period='".$d10."' ");
                $sicknessofd10 = mysqli_num_rows($qofd10);

//Dependants
$qnot= mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$now."' ");
                $sicknessnot = mysqli_num_rows($qnot);
$qnot1 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d1."' ");
                $sicknessnot1 = mysqli_num_rows($qnot1);
$qnot2 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d2."' ");
                $sicknessnot2 = mysqli_num_rows($qnot2);
$qnot3 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d3."' ");
                $sicknessnot3 = mysqli_num_rows($qnot3);
$qnot4 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d4."' ");
                $sicknessnot4 = mysqli_num_rows($qnot4);
$qnot5 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d5."' ");
                $sicknessnot5 = mysqli_num_rows($qnot5);
$qnot6 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d6."' ");
                $sicknessnot6 = mysqli_num_rows($qnot6);
$qnot7 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d7."' ");
                $sicknessnot7 = mysqli_num_rows($qnot7);
$qnot8 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d8."' ");
                $sicknessnot8 = mysqli_num_rows($qnot8);
$qnot9 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d9."' ");
                $sicknessnot9 = mysqli_num_rows($qnot9);
$qnot10 = mysqli_query($con,"SELECT * from tblreport where category='Not Specified' and period='".$d10."' ");
                $sicknessnot10 = mysqli_num_rows($qnot10);

//non employees
$qnon= mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$now."' ");
                $sicknessnon = mysqli_num_rows($qnon);
$qnon1 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d1."' ");
                $sicknessnon1 = mysqli_num_rows($qnon1);
$qnon2 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d2."' ");
                $sicknessnon2 = mysqli_num_rows($qnon2);
$qnon3 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d3."' ");
                $sicknessnon3 = mysqli_num_rows($qnon3);
$qnon4 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d4."' ");
                $sicknessnon4 = mysqli_num_rows($qnon4);
$qnon5 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d5."' ");
                $sicknessnon5 = mysqli_num_rows($qnon5);
$qnon6 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d6."' ");
                $sicknessnon6 = mysqli_num_rows($qnon6);
$qnon7 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d7."' ");
                $sicknessnon7 = mysqli_num_rows($qnon7);
$qnon8 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d8."' ");
                $sicknessnon8 = mysqli_num_rows($qnon8);
$qnon9 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d9."' ");
                $sicknessnon9 = mysqli_num_rows($qnon9);
$qnon10 = mysqli_query($con,"SELECT * from tblreport where category='Non Employee' and period='".$d10."' ");
                $sicknessnon10 = mysqli_num_rows($qnon10);

//MCH
$qmch= mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$now."' ");
                $mch = mysqli_num_rows($qmch);
$qmch1 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d1."' ");
                $mch1 = mysqli_num_rows($qmch1);
$qmch2 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d2."' ");
                $mch2 = mysqli_num_rows($qmch2);
$qmch3 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d3."' ");
                $mch3 = mysqli_num_rows($qmch3);
$qmch4 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d4."' ");
                $mch4 = mysqli_num_rows($qmch4);
$qmch5 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d5."' ");
                $mch5 = mysqli_num_rows($qmch5);
$qmch6 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d6."' ");
                $mch6 = mysqli_num_rows($qmch6);
$qmch7 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d7."' ");
                $mch7 = mysqli_num_rows($qmch7);
$qmch8 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d8."' ");
                $mch8 = mysqli_num_rows($qmch8);
$qmch9 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d9."' ");
                $mch9 = mysqli_num_rows($qmch9);
$qmch10 = mysqli_query($con,"SELECT * from tblreport where purpose='MCH' and period='".$d10."' ");
...
var chart = new CanvasJS.Chart("chartContainer", {
    ...
    title: {
        text: "Treatment category in the last 10 years in ALL estates"
    },
    axisY: {
