                                ...
                                <div class="col-sm-4">
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body" style="background-color: gray; color: #fff">
                                            <h2 class="text-center">Bronze Package </h2>
                                            <h3 class="text-center">2,500 <sub>KES</sub></h3>
                                            <h4 class="text-center">Per month</h3>
                                            </div>
                                            <div class="panel-body">
                                        <p> Projects (events) management <span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p>
                                            <p> Customer Registration <span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p> 
                                            <p> Invoice <span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p> 
                                            <p> Printing reports<span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p> 
                                            <p> Leasing items<span style="float:right"><i class="fa fa-close" style="color: red"></i></span></p>
                                            <p> Returning items <span style="float:right"><i class="fa fa-close" style="color: red"></i></span></p>
                                            <p> Inventory management <span style="float:right"><i class="fa fa-close" style="color: red"></i></span></p>
                                            <p> Penalities <span style="float:right"><i class="fa fa-close" style="color: red"></i></span></p>
                                        ...
                                        <form action="m.php" method="POST">
                                            ...
                                            <input hidden type="text" value="Basic Package" name="package"/>
                                ...
                                <div class="col-sm-4">
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body" style="background-color: skyblue; color: #fff">
                                            ...
                                            <h3 class="text-center">3,000 <sub>KES</sub></h3>
                                        ...
                                        <form action="m.php" method="POST">
                                            ...
                                            <button class="btn btn-success" style="border-radius: 20px;" type="submit" value="3000" name="pay">Make Payment</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body" style="background-color: orange; color: #fff">
                                            <h2 class="text-center">Gold Package </h2>
                                        ...
                                        <p> Projects (events) management <span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p>
                                            ...
                                            <p> Unlimited user accounts<span style="float:right"><i class="fa fa-check" style="color: green"></i></span></p>
                                        <form action="m.php" method="POST">
                                            <input hidden type="text" value="<?php $_SESSION['company']; ?>" name="user"/>
                                            <input hidden type="text" value="Premium Package" name="package"/>
