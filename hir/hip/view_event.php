...
//							 
                        ...
                        echo '<a class="btn btn-success btn-sm form-group" style="margin-top:30px;margin-bottom:30px;" onclick="approveConfirm('.$event_id.'); " href="javascript:void(0);" ><i class="fas fa-save"></i>&nbsp;Approve Quotation and Generate Invoice</a>&nbsp;&nbsp;&nbsp;';
                              ...
                              ?>
												...
												<div class="box-body table-responsive">
													<div class="form-row">
														...
														<a class="btn btn-info btn-sm form-group" style="margin-top:10px;margin-bottom:30px;" href="lease-invoice?id=<?php echo $event_id ?>" target="_blank">Pay <i class="fas fa-circle-arrow-right"></i></a>
