                    ...
                    <div class="wrap-content container" id="container" style="width: 100%;height: 100%;">
                        ...
                        <!-- start: BASIC EXAMPLE -->
                            ...
                            <div class="row">
                                <br>
                                 <div class="col-sm-4">
                                    <a href="../usad/todo" title="To do list">
                        ...
                        $total = $tdd + $tddd;
                                      ...
                                      if($tdd>0 || $tddd>0){
                                echo '<span style="color:#fff;float:right;background-color:red;" class="badge">'.$total.'</span>'; 
                                        }else{
                                echo '';          
                                        } 
                                         ?>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body">
                                            ...
                                            <span style="color:#fff;margin-left: 14px;">My task assigments </span>
                                            <span style="color:#fff;float:right;"> <?php
                                            $q = mysqli_query($con,"SELECT distinct proj FROM tblongoing_tasks where user LIKE '%".$_SESSION['userid']."%' ");
                                            $num_rows = mysqli_num_rows($q);
                                            echo number_format($num_rows,0);
                                        ?></span>
                                        </div>
