...
WHERE EXISTS (SELECT * FROM tbltasks WHERE tblprojects.project = tbltasks.project and tbltasks.employee_id like '%".$_SESSION['userid']."%' )";
					...
					$sde=mysqli_query($con,"SELECT * FROM tbltasks WHERE project='Event' AND employee_id='$empid'");
					if($sde){
