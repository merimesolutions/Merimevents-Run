							...
							<div class="container overflow-auto col-lg-8 col-md-8 col-sm-8" style="height: 550px;">
								<section class="msger">
									<header class="msger-header">
										<div class="">
											<i class="fas fa-comments fa-2x " style="color:#ffad33;font-size: 13px;"></i>&nbsp;&nbsp; CHAT ROOM
										</div>
									</header>
							...
							<div class="col-lg-4 col-sm-12 col-md-4" style="height:550px!important; overflow: auto!important;">
								<section class="msger">
									...
									<div id="chatscreen" class="msger-chat">
										...
										<div class="form-row">
											<?php
									$squery = mysqli_query($con, "select * from tblusers where company='".$_SESSION['company']."' AND id!='$user_id' ORDER BY full_name ");
...
<?php
						$q = mysqli_query($con,"SELECT * FROM singlefaq where rec_id ='$user_id' and sender_id='$rec_id' and reply IS NULL");
