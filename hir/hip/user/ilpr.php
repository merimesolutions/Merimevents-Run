...
class myPDF extends FPDF{
    ...
    $tots=$vats + $a['paid'];
        ...
        echo
        $this->Cell(117,6,'', 0,0,'L');
        $this->Cell(35,6,'VAT', 1,0,'R');
        $this->Cell(35,6,$vats, 1,1,'R');
        }
        $this->Cell(117,6,'', 0,0,'L');
        $this->Cell(35,6,'Balance', 1,0,'R');
        $this->Cell(35,6,number_format(($ttle['product']*$dif)-$a['paid'],2), 1,1,'R');
