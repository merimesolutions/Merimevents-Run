                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Status</th>
                                                <?php  if($r_return==1){
                                                echo '<th style="background-color: teal;color: #fff;text-align: center;" >Return</th>';
                                                }?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        where tblleased.company = '$company'
                                          ORDER BY id DESC";
                                            ...
                                            <tr>
                                                ...
                                                if($r_return==1){
                                                echo '<td><center><a data-target="#editirs'.$row['item_id'].'" data-toggle="modal"><img src="../../images/icons/returning.png" title="Returning action" class="iconb"></a></center></td> ';
                                                  }echo '                              
                                                </tr>
                                                ';
