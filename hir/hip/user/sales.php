                  ...
                  <div class="box-body table-responsive">            
                   <div class="panel-heading   "style="height:100%;"  >
                     <div class="container-fluid container-full bg-white">
                      <div class="row">
                         <form action="revenue-report.php" target="_blank" method="GET">
                          <div class="col-md-4">
                     ...
                     <!--search//dcsnmm895jk4xcjk89wnm-euiuirsdkl478895nuieryu-->
                        ...
                        <!--<div id="hide_us">-->
                        <!--<P>From:</p>-->
                        <!--<input type="date"  class="form-control"   name="start2" id="custom_start search//dcsnmm895jk4xcjk89wnm-euiuirsdkl478895nuieryu" style="width:100%;overflow: flex; margin-bottom:5px; float:left" />-->
                        <!--<P>To:</p>-->
                        <!--<input type="date"  class="form-control "  name="end2" id="custom_end search//dcsnmm895jk4xcjk89wnm-euiuirsdkl478895nuieryu" style="width:100%;overflow: flex; margin-bottom:5px; float:left" />-->
                        <!--</div>-->
