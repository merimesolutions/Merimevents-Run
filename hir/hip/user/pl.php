        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header" >
                    ...
                    <a href="archived-pl" ><i class="fa fa-archive" aria-hidden="true" style="padding-top:10px;"></i> Archived Projects</a>&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="dropdown" style="position: absolute;right:15px;margin-top: 10px;float:right;">
                <button class="btn btn-danger btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 2px 20px;">
                Action
                </button>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="padding:10px;">
                <input type="submit" name="archive_project"  class="dropdown-item" style="background-color:transparent ; border:none;" value="Archive project"> 
                                    ...
                                    <table id="table" class="table  table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $query  = "SELECT tblprojects.id, tblprojects.project,tblprojects.description, tblprojects.deadline,tblprojects.started,tblprojects.status
                                                FROM 
                                                tblprojects
                                                where company='".$_SESSION['company']."' and (del=0 or del IS NULL) 
                                                ORDER BY id desc";
