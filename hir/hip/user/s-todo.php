                                        ...
                                        $query  = "SELECT * FROM 
                                            ...
                                            $result = mysqli_query($con, $query);
                                                while ($row = mysqli_fetch_array($result))
                                                    ...
                                                    if($row['status'] != 1) {
                                                        $status = "Pending";
                                                        $action = '<a class="text-success" onclick="sTatus('.$row['id'].')" style="cursor:pointer;"><i class="nav-icon fas fa-pencil-square-o"></i> Done';
                                                    } else{
                                                        $status = "Done";
                                                        $action = '<a class="text-danger" onclick="rEdo('.$row['id'].')" style="cursor:pointer;"><i class="nav-icon fas fa-redo"></i> Redo';
                                                    }
