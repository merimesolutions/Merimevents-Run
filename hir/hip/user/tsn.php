              ...
              <option value="3">Not Urgent</option>
                ...
                <section id="result" class="content" style="width: 100%;height: 100%;">
                      ...
                      <div class="box">
                        ...
                        <h5 style="padding:2px;"><strong style="color:#000;">Project:</strong> <?php
                        $q  = "SELECT * FROM tblprojects where id = '".$_GET['proj']."' ";
                     ...
                     $query  = "SELECT * FROM tasks where project_id = '".$_GET['proj']."' and user =  '".$_SESSION['userid']."' ORDER BY task_progress ";   
                                             ...
                                             $status = '<p style="color: black;">'. "Halfway done" .'</p>';   
                                              ...
                                              //My switch guy............................
                                               switch($urgency){
                                                 ...
                                                 $t ='<p style="color:#000;">'.ucwords($row['task_name']).'</p>';  
                                                        }
                                                     break;
                                                     case 2:
                                                         if($per!=100){ 
                                                     $t ='<p style="color:#ff6600;">'.ucwords($row['task_name']).'</p>';
                                                         }else{
                                                 $t ='<p style="color:#000;">'.ucwords($row['task_name']).'</p>';  
                                                         }
                                                   break;
                                                    case 3:
                                                         if($per!=100){ 
                                                     $t ='<p style="color:#00cc66;">'.ucwords($row['task_name']).'</p>';
                                                         }
                                                   break;
                                                 default:
              ...
              $q = mysqli_query($con,"SELECT * FROM faq where task='".$row['id']."' and reply IS NULL and user !='".$_SESSION['userid']."' ");
                ...
                $new_sms = '';
                                            ...
                                            <tr>
                                                ...
                                                <td>'.ucwords($row["task_progress"]).' % '.$new_sms.'</td>
