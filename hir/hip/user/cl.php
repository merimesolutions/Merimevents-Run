							...
							<form method="post">
								...
								<div class="tab-content">
									...
									<div id="menu1" class="tab-pane fade">
										...
										<button type="submit" onclick="return confirm('Are you sure you want to delete these leads?')" name="submit_leads" style="margin-top:10px!important; float:right; margin-bottom:10px!important" class="btn btn-danger btn-sm ">Delete selected leads <i class="fas fa-users"></i></button>
