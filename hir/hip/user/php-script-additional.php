            ...
            if(!empty($_POST['costQuantity'][$key2])){
             ...
             $supplier=$_POST['costSupplier'];
              ...
              $total=$total_price;
                ...
                $sqme =mysqli_query($con,"INSERT INTO additional_costs(event_id,cost_name,cost_description,cost_quantity,cost_price,company,costperunit,total_price,supplier) VALUES ('$event_id','$value2','$cost_description[$key2]','$cost_quantity[$key2]','$total_price','$company','$cost_unit_price[$key2]','$total','$supplier[$key2]')");
