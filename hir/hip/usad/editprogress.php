        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input name="progress_edit_sy" id="progress_edit_sy" class="form-control input-sm" type="number" min="0" max="100" maxlength="3" pattern="[0-9]+" value="'.ucwords($row['task_progress']).'" required/>
