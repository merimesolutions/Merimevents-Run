...
class myPDF extends FPDF{
     function hd($con){
        ...
        $this->Cell(190,7,ucwords($r['companyname']),0,0,'C');
        $this->Ln(5);
        $this->SetFont('Arial','',10);
        $this->Cell(190,7,ucwords($r['location']),0,0,'C');
        $this->Ln(5);
        $this->Cell(190,7,ucwords($r['contact']),0,0,'C');
        $this->Ln(5);
        $this->Cell(190,7,$r['email'],0,0,'C');
        $this->Ln(5);
