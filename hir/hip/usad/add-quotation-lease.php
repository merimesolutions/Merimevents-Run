                                ...
                                <form method="post">
                                  <div class="row">
                                    <div class="col-lg-2">
                                      ...
                                      <input type="text" name="quotation_id" id="quoteid" class="form-control" placeholder=<?php echo RandomID(3);?> value="<?php echo RandomString(3); ?>"/>
                                    ...
                                    <div class="col-lg-2">
                                      ...
                                      <input type="date" name="e_date" id="e_date" class="form-control" placeholder="Expiry Date" required>
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <input type="text" class="form-control" name="myInput" value=""  list="cust" id="myInput" placeholder="Enter Customer Name" Required>
...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","get-item-quote-lease.php?q="+str+"&c="+event_id+"&quoteid="+quoteid+"&quotet="+quotet+"&l_date="+l_date+"&e_date="+e_date+"&quotation_status="+quotation_status+"&myInput="+myInput,true);
    xmlhttp.send();
  }
} 
