      ...
      $results = mysqli_query($con,$sql_u);
        if(mysqli_num_rows($results)>0){
            ...
            echo '<script type="text/javascript">'; 
                ...
                echo 'window.location = "c";';
                echo '</script>';
    }else{

         echo  $sql="insert into tblcustomers(fname,mname,lname,gender,code,box,town,identity,phy_address,fcontact,scontact,email,b_c_name,b_c_location,company,customer_name,state,customer_website,customer_industry,add_info,interested_in) VALUES('$fname','$mname','$lname','$gender', '$code', '$box','$town', '$identity', '$phy_address','$fcontact','$scontact','$email','$b_c_name','$b_c_location','$company','$customer_name','$customer','$customer_website','$customer_industry','$add_info','$user_name')";
                  
          if(mysqli_query($con, $sql)){

                echo '<script type="text/javascript">'; 
                echo 'alert("The customer has been registered successfully.");'; 
                echo 'window.location = "cl";';
                echo '</script>';
          } else {
            echo '<script type="text/javascript">'; 
		...
		<aside class="right-side">
			...
			<form role="form" method="post" enctype="multipart/form-data">
				...
				<section class="content">
							...
							<div class="col-md-12 col-sm-12">
								<div class="panel panel-default" style="">
									...
									<table class="table table-striped">
										<tr>
											<th style="width: 42%">
												<p>National Identification Number / Passport No. </p>
											</th>
											<th>
										...
										<tr>
											<td>
												<input type="text" class="form-control" style="width:100%" name="identity" placeholder="Enter National Identification Number" autocomplete="off" title="National Identification Number" pattern="[0-9]+">
											</td>
											<td>
									...
									<table class="table table-striped">
										...
										<tr>
											...
											<td>
												<div class="dropdown">
                                          <button class="btn btn-sm btn-default dropdown-toggle form-control" type="button" 
					...
					<input type="hidden" name="sysid" id="sysid" value="SYSID:<?php echo RandomString(5); ?>" />
