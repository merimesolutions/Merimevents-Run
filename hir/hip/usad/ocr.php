    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <a href="add-item" title="Lease item" class="btn btn-info btn-sm" style="margin-top:10px;margin-left:20px;">  Lease Items</a>&nbsp;&nbsp;&nbsp;
                <a href="quotation-list" title="Quotation list" class="btn btn-success btn-sm" style="margin-top:10px;margin-left:20px;">  Quotations</a>
                <!-- Main content -->
                                    ...
                                    <table id="table" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <!--th style="width: 100px !important;">Identity N<sub>o</sub></th-->
                                                <th>Customer Name</th>
                                                <!--<th>Gender</th>-->
                                                <!--th>Business / Company</th-->
                                                <th>Contact</th>
                                                <th style="width: 20px !important;">Lease</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--td><a href=add-item?client='.$row['identity'].' target="_parent">'.$row['identity'].'</a></td-->
                                                <td><a href=add-item?client='.$row['identity'].' target="_parent">'.ucwords($row['fname']).' '.ucwords($row['mname']).' '.ucwords($row['lname']).'</a></td>
                                                
                                                <!--td><a href=add-item?client='.$row['identity'].' target="_parent">'.ucwords($row['b_c_name']).'</a></td-->   
                                                <td><a href=add-item?client='.$row['identity'].' target="_parent">'.ucwords($row['fcontact']).'</a></td> 
                                                <td><a class="btn btn-info btn-sm" href=add-item?client='.$row['identity'].' target="_parent">Lease</a></td>
