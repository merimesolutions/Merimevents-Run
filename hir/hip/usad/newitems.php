        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <a href="purchases.php" title="Go back"><i class="fa fa-angle-double-left" aria-hidden="true" title="Go back"></i> Back</a>&nbsp;&nbsp;&nbsp;

                    <a href="../reports/news.php" target="_blank"><i class="fa fa-print" aria-hidden="true" title="Go back"> Print</i></a>
                        ...
                        <div class="box-body table-responsive">   
                            <form method="post">
                                    <table id="table" class="table table-striped">
                                        ...
                                        $query  = "SELECT tblitems.item_name,tblitems.qnty,tblitems.category,tblitems.bno, tblitems.added_by, tblitems.added_date, tblitems.company,tblitems.supplier, tblitems.receipt, tblitems.lease_charges
                                                item_name,qnty,category,bno,added_by,added_date,company,supplier,receipt,lease_charges
                                                FROM 
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$row['qnty'].'</td>
                                                <td>'.ucwords($row['lease_charges']).'</td>
                                                <td>'.ucwords($row['supplier']).'</td>
                                                <td>'.ucwords($row['receipt']).'</td>
