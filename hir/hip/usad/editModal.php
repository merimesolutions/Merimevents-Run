        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="fname_edit_sy" id="fname_edit_sy" class="form-control input-sm" type="text" style="width:100%"   value="'.ucwords($row['fname']).'" />
                    <br>
                    <label>Middle Name </label>
                    <input name="mname_edit_sy" id="mname_edit_sy" class="form-control input-sm" type="text"   style="width:100%" value="'.$row['mname'].'" />
                    <br>
                    <label>Last Name </label>
                    <input name="lname_edit_sy" id="lname_edit_sy" class="form-control input-sm" type="text"   style="width:100%" value="'.$row['lname'].'" />
                    <br>
                    <label>Gender </label>
                    <input name="gender_edit_sy" id="gender_edit_sy" class="form-control input-sm" type="text"   style="width:100%" value="'.ucwords($row['gender']).'" />
                    <br>
                    ...
                    <input name="phy_address_edit_sy" id="phy_address_edit_sy" class="form-control input-sm" type="text"   style="width:100%" value="'.ucwords($row['phy_address']).'" />
					<br>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input name="box_edit_sy" id="box_edit_sy" class="form-control input-sm" type="text" style="width:100%" pattern="[0-9]+" value="'.$row['box'].'" />
                     ...
                     <br>
                    <label>Town </label>
                    <input name="town_edit_sy" id="town_edit_sy" class="form-control input-sm" type="text" style="width:100%"  value="'.ucwords($row['town']).'" />
                    ...
                    <input type="hidden"  value="'.$row['state'].'" name="customer_state">
                   ...
                   if($row['state']=='0'){
                    ...
                    <input name="customer_website" i class="form-control input-sm" type="text" style="width:100%" value="'.$row['customer_website'].'" />
					<br>
                    <label>What does the customer do(Industry)</label>
                    <textarea name="customer_industry" class="form-control" rows="4" style="width:100%">'.$row['customer_industry'].'</textarea>
					<br>
					<label>Additional Information</label>
					  <textarea name="add_info" class="form-control" rows="4" style="width:100%">'.$row['add_info'].'</textarea>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <label>First Name </label>
                    <input name="fname_edit_sy" id="fname_edit_sy" class="form-control input-sm" type="text" style="width:100%"   value="'.ucwords($row['fname']).'" readonly/>
                    <br>
                    <label>Middle Name </label>
                    <input name="mname_edit_sy" id="mname_edit_sy" class="form-control input-sm" type="text"   style="width:100%" value="'.$row['mname'].'" readonly />
                    <br>
                    <label>Last Name </label>
                    <input name="lname_edit_sy" id="lname_edit_sy" class="form-control input-sm" type="text"  style="width:100%" value="'.$row['lname'].'" readonly/>
                    <br>
                    <label>Gender </label>
