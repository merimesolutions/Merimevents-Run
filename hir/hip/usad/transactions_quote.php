                    ...
                    <div class="row">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    //         {
                                        $id23= $_GET['quote'];
                                        $i=$_GET['id'];
                                                $squery33 = mysqli_query($con,  "SELECT * FROM tblquotation WHERE identitty=$i order by id DESC");
                                            $rows11 = mysqli_fetch_assoc($squery33);
                                            // {
                                          ...
                                          $itt=$rows11['item_name'];
                                            ...
                                            <tr> 
                                                ...
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$rows11['identitty'].' </a></td>
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$rows11['item_name'].' </a></td> 
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$rows11['quantity'].' </a></td>
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$rows11['total_amount'].' </a></td>
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$rows11['date_create'].' </a></td>
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$ed.' </a></td>    
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"> '.$cb.' </a></td> 
                                                
                                                
                                                <td><a href="payment-receipt.php?receipt='.$rows['id'].'" target="_blank" title="Print Receipt"><i class="fa fa-print" aria-hidden="true" title="Print"></i> Print Receipt</a></td>                             
                                                </tr>
