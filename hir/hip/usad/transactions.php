                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                               <?php
                                            $c=1;
                                    $c = mysqli_query($con, "SELECT * FROM tbltransactions WHERE random ='".$_GET['tjk78wenm4yuwernmnmzxcyunmnmztye7834nm434nm43rf//578nmsdjn//sdfjkmerime']."' ORDER BY id desc");
                                                while($row = mysqli_fetch_array($c))
                                            {
                                                $squery = mysqli_query($con, "SELECT distinct random,invoice,client,ldate,lease_time,company from tblleased where company='".$_SESSION['company']."' ");
                                            ...
                                            <tr> 
                                                ...
                                                <td><a href="payment-receipt.php?receipt='.$row['id'].'" target="_blank" title="Print Receipt"> '.$row['date_paid'].' </a></td>
                                                <td><a href="payment-receipt.php?receipt='.$row['id'].'" target="_blank" title="Print Receipt"> '.$row['trans'].' </a></td> 
                                                
                                                <td><a href="payment-receipt.php?receipt='.$row['id'].'" target="_blank" title="Print Receipt"> '.number_format($row['amount'],2).' </a></td> 
                                                
                                                <td><a href="payment-receipt.php?receipt='.$row['id'].'" target="_blank" title="Print Receipt"> '.ucwords($row['served_by']).' </a></td> 
