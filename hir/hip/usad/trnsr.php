...
class myPDF extends FPDF{
    ...
    $total=mysqli_query($con,'select sum(total_cost) as product from tblleased WHERE random = "'.$_GET['tjk78wenm4yuwernmnmzxcyunmnmztye7834nm434nm43rf//578nmsdjn//sdfjkmerime'].'" ');
