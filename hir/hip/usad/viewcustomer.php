				...
				<?php
                 ...
                 $admin = mysqli_query($con,"SELECT * from tblstaff where id =' ".$_SESSION['userid']."' ");
                    while($rows = mysqli_fetch_array($admin)){
                        ...
                        if($package!=4){?>
				<a href="add-item?client=<?php echo $rows['identity']; ?>" target="_parent" title="Lease item" class="btn btn-info btn-sm" style="margin-bottom:10px;"> Lease Items</a>&nbsp;&nbsp;&nbsp;
			<?php }} ?>
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<input name="phy_address_edit_sy" id="phy_address_edit_sy" class="form-control input-sm" type="text" style="width:100%" value="<?php echo $row['email']; ?>" readonly />
										</div>
