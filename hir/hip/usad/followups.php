...
$redd=mysqli_query($con,"INSERT INTO customer_comments(customer_comment,customer_person,customer_followup,customer_date,customer_prefdate,customer_id,customer_additional,customer_progress,company,role,comment_date, demo_date,followup_user,followup_userid,followup_userole) VALUES ('$cust_comment','$cust_person','$cust_followup','$todate','$cust_prefdate','$cust_id','$additional','$progresz','$compzz','admin',NOW(),'$demo_date','$followup_user','$followup_userid','$followup_userole')");
if($redd){
						...
						<form method="post">
							...
							while($romm =mysqli_fetch_array($sdo)){
							   ...
							   //FOLLOWUP ASSIGNMENTS
								...
								if(($romm['followup_userid'] !== $cust_person) && (!empty($romm['followup_userid']))){
...
//
								...
								<tbody class="showcontent2" style="display:none;">
									...
									<?php
									$b=1;
							$sdo1=mysqli_query($con,"SELECT * FROM customer_comments WHERE company='$compzz' AND customer_progress!='Completed' ORDER BY customer_prefdate DESC");
...
//
							...
							$sdo2=mysqli_query($con,"SELECT * FROM customer_comments WHERE(company='$compzz' AND followup_userid='$cust_person') ||(company ='$compzz' AND followup_userid ='$empn1')");
...
//
								...
								<tbody class="showcontent4" style="display:none;">
									...
									$empn=NULL;
									$p=1;
							$sdo3=mysqli_query($con,"SELECT * FROM customer_comments WHERE company='$compzz' AND followup_userid!='$cust_person' AND followup_userid !='$empn'");
