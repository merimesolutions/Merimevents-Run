                            ...
                            <div class="row">
                             ...
                             while($rw = mysqli_fetch_array($sq))
                                ...
                                if($package == 1 ||  $package == 2 || $package == 3){ 
                                    echo '
                                <div class="col-sm-4" style="">
                                    <a href="payment" title="Lease items">
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body">
                                            <span class="fas fa-money-check fa-1x" style="font-size: 20px;"></span>
                                            <span style="color:#000;margin-left: 7px;"> Payment report</span>   
                                        </div>
                                    </div>
                                    </a>
                                </div>'; } 
                                ...
                                if($package == 1 ||  $package == 2 || $package == 3){ 
                                    echo '
                                <div class="col-sm-4" style="">
                                    <a href="purchases" title="Lease items">
                                    <div class="panel panel-white no-radius">
                                        <div class="panel-body">
                                            <span class="fas fa-money-check fa-1x" style="font-size: 20px;"></span>
                                            <span style="color:#000;margin-left: 7px;"> Purchase report</span>   
                                        </div>
                                    </div>
                                    </a>
                                </div>'; } 
