	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				...
				<a href="events-invoice-prev?id=<?php echo $event_id; ?>" title="Add new customers"><i class="fas fa-eye" aria-hidden="true" title="Go home"></i>View Invoices</a>&nbsp;&nbsp;&nbsp;
								...
								<table class="table  table-striped">
									...
									<tbody>
                                              ...
                                              $sqw =mysqli_query($con,"SELECT SUM(cost_price) AS total FROM additional_costs WHERE event_id='$event_id'");
                                                     ...
                                                     if($rem){
                                                         ...
                                                         while($roml =mysqli_fetch_assoc($rem)){
                                                            ...
                                                            $overall_total = $total_add_costs + $cost_price;
                                                             ?>
										<tr>
											<td><?php echo $c++; ?></td>
										...
										<tr>
											...
											<td></td>
											<td>
												<input style="text-align: right;" type="text" class="form-control" value="<?php echo number_format($overall_total,1); ?>" readonly></td>
