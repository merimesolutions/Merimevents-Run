...
$delete_query = mysqli_query($con,"DELETE from additional_costs where id = '$id' ") or die('Error: ' . mysqli_error($con));
     if($delete_query == true)
         ...
         echo '<script>alert("'."$errom".' ");window.location="edit_quotation_ex?id='.$event_id.'";</script>';
     }
 }
...
if(isset($_POST['edit_details'])){
	...
	'$event_id'");
	if($upds){
		echo'<script>window.location="edit_quotation_ex?id='."$event_id".'";</script>';
	}
}
?>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			<section class="content-header">
				...
				<a href="edit_ex?id=<?php echo $event_id; ?>" target="_blank"><i class="fas fa-plus" aria-hidden="true"></i>Add items</a>&nbsp;&nbsp;&nbsp;
						...
						<div class="box-body table-responsive">
							...
							<form method="post">
								<div style="margin-top:50px!important;">
									<span><a href="edit_ex?id=<?php echo $event_id; ?>" class="btn btn-info btn-sm">Add more items</a></span>
								</div>
