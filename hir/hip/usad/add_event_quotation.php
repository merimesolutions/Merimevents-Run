                          ...
                          <h4 class="text-center text-info" style="margin-bottom: 30px; text-transform:uppercase;">Add Quotation For&nbsp;<?php echo $customer_name;?>'s &nbsp;<?php echo $event_name;?></h4>
                                ...
                                <form method="post" class="insert=form" id="insert_form" action="">
                                    <table class="table table-striped" id="table_field">
                                      <tr>
                                            <th>Date</th>
                                            <th colspan="5"><input type="text" name="lease_date" class="form-control" value="<?php echo date("Y-m-d"); ?>"></th>
                                       ...
                                       if(!empty($_POST['txtDescription'])){
                                        ...
                                        while($hd = mysqli_fetch_array($ddd)){
                                            ...
                                            $get_name=$hd['item_name'];
                                                ...
                                                $sqle =mysqli_query($connn,"INSERT INTO event_quotation(event_id,customer_name,event_item,event_description,event_quantity,event_single_price,event_days,total_items,company,lease_date) VALUES ('$event_id','$customer_name','$value','$txtDescription[$key]',' $txtQnty[$key]','$txtbal_Price[$key]','$no_days','$total_items_cost','$company','$lease_date')");
                                                if(!$sqle){
                                            ...
                                            if(!empty($_POST['costQuantity'][$key2])){
                                             ...
                                             $supplier=$_POST['costSupplier'];
                                              ...
                                              $total=$total_price;
                                                ...
                                                $sqme =mysqli_query($connn,"INSERT INTO additional_costs(event_id,cost_name,cost_description,cost_quantity,cost_price,company,costperunit,total_price,supplier) VALUES ('$event_id','$value2','$cost_description[$key2]','$cost_quantity[$key2]','$total_price','$company','$cost_unit_price[$key2]','$total','$supplier[$key2]')");
