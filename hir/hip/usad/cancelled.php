        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header" style="border-style:;border:1px solid #dedede;">
                    ...
                    <a href="invoices.php" title="Go invoices"><i class="fa fa-folder-open" aria-hidden="true" title="Go invoices"></i> Invoices</a>&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                               <?php
                                            $c=1;
                                            $squery = mysqli_query($con, "select distinct random,invoice,client,ldate,lease_time,company,cancellation,cancelled_by,cancelled_date from tblleased where company='".$_SESSION['company']."' and cancellation !='active' group by item_id ");
                                          ...
                                          if($ttle['product'] != $amount && $amount==""){
                                            ...
                                            <tr> 
                                                ...
                                                <td><a href=ilpr.php?tm='.$invoice.' target="_blank">'.$row['cancelled_date'].'</a></td>
                                                <td><a href=ilpr.php?tm='.$invoice.' target="_blank">'.$row['cancellation'].' </a></td>
                                                <td><a href=ilpr.php?tm='.$invoice.' target="_blank">'.$row['cancelled_by'].' </a></td>
