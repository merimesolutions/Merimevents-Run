                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="table" class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $qry  = "SELECT a.client, a.item_name_id, a.qnty, a.price, a.total_cost, b.identity, b.fname,mname,lname
                                            FROM tblleased a 
                                    ...
                                    $q = "SELECT * FROM tbloverdate where item_name_id_overdue ='".$z."' and client='".$client."' ";
                                            ...
                                            <tr> 
                                                ...
                                                <td><center><a href="transactions_overdue.php?overdue='.$rows['client'].'"><img src="../../images/icons/eye.png" title="Edit this record" class="iconb"></a></center></td>
                                        
                                                <td><center><a  href="overdue-prview?tm='.$rows['client'].'" target="_blank" class="form-control btn-success"><i class="fas fa-file-invoice"></i></a></center></td> 
                                                <td><a class="form-control btn btn-info" data-target="#editpay'.$rows['invoice'].'" data-toggle="modal"><small>Pay</small></a></td>  
                                                <td><center><a class="form-control" data-target="#editd'.$rows['invoice'].'" data-toggle="modal"><i class="nav-icon fas fa-edit"> </a></center></td>  
                                                  <td><a class="form-control btn btn-danger" href="overdue-penalties?client_delete='.$rows['client'].'"><small>Cancel</small></a></td>   
                                                </tr>
