...
<table border="1">
  ...
  { echo '
        <a href="quotation-list" target="_blank" class="btn btn-primary btn-sm form-group" >&nbsp;Save</a>';
...
?>
 ...
 echo '<tr>
        ...
        <td> <input type="submit" value="Delete" name="delete_this"  onclick="window.location = "delete_qq?id='.$quoteid.'""></td>
...
// <td><a cla <td><a class="" style="cursor: pointer;" href="delete_qq?id='.$quoteid.'"><i class="fa fa-trash"> </i> Delete</a></td>
// ss="" style="cursor: pointer;" href="delete_qq?id='.$quoteid.'"><i class="fa fa-trash"> </i> Delete</a></td>
