        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <a href="../reports/rests.php" target="_blank"><i class="fa fa-print" aria-hidden="true" title="Go back"> Print</i></a>
                        ...
                        <div class="box-body table-responsive">   
                            <form method="post">
                                    <table id="table" class="table table-striped">
                                        ...
                                        $query  = "SELECT tblitems.id, tblitems.item_name,tblitems.qnty,tblitems.qlty,tblitems.bno, tblitems.lease_charges, tblitems.category, tblitems.added_date,tblitems.added_by
                                                FROM 
