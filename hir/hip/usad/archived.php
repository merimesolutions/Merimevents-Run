        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <?php include('../sidebar-left.php'); ?>
             <aside class="right-side">
                 ...
                 <a class=""  href="events"  title="Archived events" style="margin-bottom:5px;"><i class="fa fa-tasks" ></i> Active events</a>  
                </section>
      <!--=======================================================================================================================-->
...
<input type="submit" name="restore_event"  class="dropdown-item" style="background-color:transparent ; border:none;" value="Restore event"> 
 <input type="submit" name="delete_event"  class="dropdown-item" style="margin-top:10px !important;background-color:transparent ; border:none;" value="Delete event">
                                        ...
                                        <tbody>
                                            ...
                                            $task=0;
                                            $date=date("Y-m-d");
                                            $query  = "SELECT * FROM tblevents WHERE company='$compp' and del=1 ";
                                            ...
                                            <td><input type="checkbox" name="events[]" value="'.$event_id.'"></td>
                                                ...
                                                <td><center><a href="add-quotation?id='.$row['id'].' " class="btn" ><img src="../../images/icons/doc_edit.png" title="Edit this record" class="iconb"></a></center></td>
                                              
                                                <td><center><a href="print-quotation?id='.$row['id'].' " class="btn btn-info" target="_blank"><i class="fas fa-file-invoice"></i></a></center></td>
                                                <td><center><a href="add-quotation?id='.$row['id'].'" ><img src="../../images/icons/eye.png" title="Edit this record" class="iconb"></a></center></td>                              
                                                </tr>
                                                ';
