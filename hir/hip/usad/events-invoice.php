                            ...
                            <form method="post">
                                    <table id="table" class="table  table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $task=0;
                                            $date=date("Y-m-d");
                                            // $qrjoined ="SELECT tblevents.id AS evid,tblevents.event_name,tblevents.customer_name,event_quotation.id,event_quotation.event_id,event_quotation.customer_name FROM tblevents LEFT JOIN event_quotation ON tblevents.id = event_quotation.event_id GROUP BY";
                                            // $resu = mysqli_query($con, $qrjoined);
                                            ...
                                            $qry  = "SELECT DISTINCT customer_name,event_id  FROM event_quotation WHERE event_id='$event_id' and customer_name !=''    ";
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="events-invoice-prev?id='.$row['id'].'" >'.$row['start_date'].'</a></td>
                                                 <td><center><a  href="events-invoice-prev?id='.$row['id'].'" target="_parent" class="form-control btn-success"><i class="fas fa-file-invoice"></i></a></center></td>

                                                   <td><a class="form-control btn btn-info" data-target="#editpay'.$row['event_id'].'" data-toggle="modal"><small>Pay</small></a></td>  
                                                <td><center><a class="form-control" data-target="#editq'.$row['id'].'" data-toggle="modal"><i class="nav-icon fas fa-edit"> </a></center></td>  
                                                <td><a class="form-control btn btn-danger" href="invoice-cancellation?invoice='.$row['id'].'"><small>Cancel</small></a></td>                           
                                                </tr> 
