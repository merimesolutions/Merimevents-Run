                ...
                <section class="sidebar" style=" border-style:none;background-color:#0a1219;">
                    ...
                    <div class="user-panel" style="border:;background-color:#0a1219;">
                        ...
                        <div class="pull-left info">
                            ...
                            $q = mysqli_query($con,"SELECT * from tblleased where rdate < '".$date."' and tblleased.company='".$_SESSION['company']."' and tblleased.comment !='cleared' ");
                        ...
                        $total = $tdd + $tddd;
                                      ...
                                      if($tdd>0 || $tddd>0){
                                $td = '<small class="badge pull-right bg-red">'.$total.'</small>'; 
                                        }else{
                                $td = '';          
                                        }      

                             $todo = '<li class="todo" style="border-style:none">
                                <a href="../usad/todo">
                                    <img src="../../images/icons/document.png" title="ToDo" class="icon-b"> <span style="color:#fff;">To Do list</span>'.$td.'
                                </a>
                            </li>'; 
...
//								  $numspan='<span class=" pull-left" style"color:#FFBF00; font-size:14px;"><strong>NEW</strong></span>';
	...
	//
	// }
	// $follow='<li class="follow" style="border-style:none">
		// <a href="../usad/followups">
			// <img src="../../images/comment.png" title="Comments" class="icon-b"> <span style="color:#fff;">Comments</span><span class="badge pull-right" style="font-family:fangsong!important; background-color:#32cd32!important;">'."$num1".'</span>
			// </a>
		// </li>';
                            ...
                            $projects = '<li class="pl" style="border-style:">
                                <a href="../usad/pl" target="_parent">
                                    <img src="../../images/icons/project.png" title="" class="icon-b"> <span style="color:#fff;">Collaborate</span>
                                </a>
                            </li>';
                            ...
                            $chat = '<li class="livechat" style="border-style:">
                                <a href="../usad/livechat" target="_parent">
                                    <img src="../../images/icons/chat.png" title="User accounts" class="icon-b"> <span style="color:#fff">Chat-room</span>
                                    <span class="badge" style="float:right;background-color:red;">chat</span>
                                </a>
                            </li>';
                    ...
                    if($_SESSION['role'] !== "admin" || $row['package'] != "0"){
                        ...
                        echo '<li class="db" class="active" style="border-style:none">
                            ...
                            <li class="todo" style="border-style:none">
                                <a href="../usad/todo">
                                    <img src="../../images/icons/document.png" title="ToDo" class="icon-b"> <span style="color:#fff;">To Do list</span>'.$td.'
                                </a>
                            </li>';
                    ...
                    if($row['register'] == "1"){
                            echo '<li class="cl" style="border-style:none">
                                <a href="../user/cl">
                                    <img src="../../images/icons/customers.png" title="Register new customer" class="icon-b"> <span style="color:#fff">Customers</span>
                                </a>
                            </li>';
                                     
                        }
//										if($row['register'] == "1"){
							// $sem2=mysqli_query($con,"SELECT * FROM customer_comments WHERE (company='$compan' AND customer_progress!='Completed' AND customer_person='$this_spec') || (company='$compan' AND customer_progress!='Completed' AND followup_userid='$this_spec')");
							//if($sem2){
							//
							// $newdate2=date('Y-m-d', strtotime($thix_date. ' -2 days'));
							// $newnew=date('Y-m-d',strtotime($thix_date. ' +2 days '));
							// $sol=mysqli_query($con,"SELECT * FROM customer_comments WHERE(company='$compan' AND customer_progress!='Completed' AND customer_date >= '$newdate2' AND customer_date <= '$newnew' AND customer_person='$this_spec' ) || (company='$compan' AND customer_progress!='Completed' AND followup_userid='$this_spec' AND customer_person='$this_spec' )"); // if($sol){ // $num2=mysqli_num_rows($sol); // $numspan='<span class="pull-left" style"color:#FFBF00; font-size:14px;"><strong>NEW</strong></span>' ; // } // //} // echo '<li class="follow" style="border-style:none">
//                                <a href="../user/followups">
//                                    <img src="../../images/comment.png" title="Comments" class="icon-b"> <span style="color:#fff">Comments</span><span class="badge pull-right" style="font-family:fangsong!important; background-color:#32cd32!important;">' ."$num2".'</span>
								// </a>
								// </li>';
								//
								// }
                    ...
                    if($row['events'] == "1"){    
                        echo '<li class="events" style="border-style:none">
                                <a href="../user/events">
                                    <img src="../../images/icons/lists.png" title="Lease item(s)" class="icon-b"> <span style="color:#fff">Events</span>
                                </a>
                            </li>';
                    }
                    ...
                    if($row['user'] == "1"){    
                        ...
                        echo '<li class="livechat" style="border-style:">
                                <a href="../user/livechat" target="_parent">
                                    <img src="../../images/icons/chat.png" title="User accounts" class="icon-b"> <span style="color:#fff">Chat-room</span>
                                    <span class="badge" style="float:right;background-color:red;">chat</span>
                                </a>
                            </li>';
